...
export default class CameraScreen extends React.Component {
  ...
  onPress = {
    ...
    <
    MaterialIcons name = {
      wbIcons[this.state.whiteBalance]
    }
  size = {
    32
  }
  ...
  renderMoreOptions = () =>
    ( <
      ...
      color = {
        this.state.faceDetecting ? "white" : "#858585"
      }
      /> < /
      TouchableOpacity > <
      TouchableOpacity onPress = {
        this.toggleBarcodeScanning
      } >
      <
      ...
      color = {
        this.state.barcodeScanning ? "white" : "#858585"
      }
      /> < /
      TouchableOpacity > <
      /View>
      ...
      <
      View style = {
        styles.pictureSizeContainer
      } >
      <
      Text style = {
        styles.pictureQualityLabel
      } > Picture quality < /Text> <
      View style = {
        styles.pictureSizeChooser
      } >
      <
      TouchableOpacity onPress = {
        this.previousPictureSize
      }
      style = {
        {
          padding: 6
