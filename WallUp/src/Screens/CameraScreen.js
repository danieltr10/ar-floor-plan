...
export default class CameraScreen extends Component {
  ...
  checkForBlurryImage(imageAsBase64) {
    return new Promise((resolve, reject) => {
      this.refs.toast.show('CameraScreen.js checkForBlurryImage',DURATION.FOREVER);

      if (Platform.OS === 'android') {
        this.refs.toast.show('CameraScreen.js checkForBlurryImage android',DURATION.FOREVER);
  ...
  async takePicture() {
    if (this.camera) {
      ...
      this.refs.toast.show('Photo taken!', DURATION.FOREVER);
    }
  }
